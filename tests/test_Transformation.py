...
class TestTransformation(unittest.TestCase):
    ...
    def test_procedure_setter(self):
        ...
        tmp.procedure = [progfunc.trans_log1p()]
        ...
        try:
            tmp.procedure = [progfunc.trans_log(), progfunc.trans_sqrt()]
        except TypeError:
    ...
    def test_add_function(self):
        ...
        self.assertSequenceEqual(tmp.get(0)([10]), progfunc.trans_log()([10]))

        tmp.add(progfunc.trans_sqrt())

        self.assertEqual(tmp.size, 2)
        self.assertSequenceEqual(tmp.get(0)([10]), progfunc.trans_log()([10]))
        self.assertSequenceEqual(tmp.get(1)([10]), progfunc.trans_sqrt()([10]))
    ...
    def test_drop_function(self):
        ...
        self.assertSequenceEqual(tmp.get(0)([10]), progfunc.trans_sqrt()([10]))
    ...
    def test_drop_last_function(self):
        ...
        tmp.drop_last()
        self.assertEqual(tmp.size, 2)
        self.assertSequenceEqual(tmp.get(0)([10]), progfunc.trans_log1p()([10]))
    ...
    def test_insert_function(self):
        ...
        tmp.insert_before(progfunc.trans_log10(), 1)

        self.assertNotEqual(tmp.get(1)([10]), progfunc.trans_sqrt()([10]))
        self.assertSequenceEqual(tmp.get(2)([10]), progfunc.trans_sqrt()([10]))
    ...
    def test_insert_first_function(self):
        ...
        tmp.insert_first(progfunc.trans_sqrt())

        self.assertNotEqual(tmp.get(0)([10]), progfunc.trans_log1p()([10]))
        self.assertSequenceEqual(tmp.get(0)([10]), progfunc.trans_sqrt()([10]))
    ...
    def test_insert_last_function(self):
        ...
        tmp.insert_last(progfunc.trans_sqrt())
        self.assertNotEqual(tmp.get(-1)([10]), progfunc.trans_log()([10]))
        self.assertSequenceEqual(tmp.get(-1)([10]), progfunc.trans_sqrt()([10]))
    ...
    def test_apply(self):
        ...
        tranfunc1 = progfunc.trans_log1p()
        tranfunc2 = progfunc.trans_sqrt()
...
class TestInstanceCheckers(unittest.TestCase):
    ...
    def test_callable_sequence(self):
        ...
        # These should be True
        self.assertTrue(callable_sequence([numpy.mean, progfunc.trans_log()]))
